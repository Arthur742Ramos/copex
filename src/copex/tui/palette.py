...
def filter_commands(
    ...
    for cmd in commands:
        ...
        if label_match or desc_match or id_match or cat_match:
            ...
            total_score = label_score * 3 + id_score * 2 + desc_score + cat_score // 2
        ...
        self.commands.extend(
            [
                ...
                PaletteCommand(
                    id="session:status",
                    label="Show Status",
                    description="Display session metrics and status",
                    category=CommandCategory.SESSION,
                ),
            ]
        )
        ...
        self.commands.extend(
            [
                ...
                PaletteCommand(
                    ...
                    description="Export usage metrics to CSV",
                    category=CommandCategory.EXPORT,
                ),
            ]
        )
        ...
        self.commands.extend(
            [
                PaletteCommand(
                    ...
                    description="Expand/collapse all tool call panels",
                ...
                PaletteCommand(
                    ...
                    description="Show/hide reasoning panel",
                    category=CommandCategory.VIEW,
                    shortcut="Ctrl+G",
                ),
                PaletteCommand(
                    ...
                    description="Show/hide bottom status bar",
                    category=CommandCategory.VIEW,
                ),
            ]
        )
